# Keybinds, contributed to the shared luaConfig. `types.lines` concatenates
# definitions, and mkAfter keeps this one last, so binds are declared after the
# settings and hyprsplit setup they refer to.
{self, ...}: {
